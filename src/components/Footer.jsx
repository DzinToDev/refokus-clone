  ...
  return (
    <div className='w-full mt-20'>
        ...
        <div className="f-left basis-1/2 p-2">
            <h1 className='text-[11vw] font-medium'>refokus.</h1>
            <p className='text-sm flex gap-8 capitalize text-zinc-600'> <span>privacy policy</span><span>cookie policy</span> <span>impressum</span><span>terms</span></p>
        </div>
        <div className="f-right basis-1/2 flex items-start justify-end gap-16 py-10">
            ...
            <div className='text-sm capitalize text-zinc-200 flex flex-col gap-3'>
               ...
               { ["home", "works", "careers", "contact"].map((elem)=>{
            ...
            <div className='w-1/3 min-h-52 flex flex-col justify-center items-start '>
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Excepturi, suscipit.</p>
                <button className='bg-blue-700 flex items-center gap-2 p-2 mt-5'><FaWebflow />Enterprice Partner</button>
            </div>
        </div>
        </div>
    </div>
